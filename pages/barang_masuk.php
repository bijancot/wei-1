               ...
               var name = $('#name').val();
                   ...
                   var deskripsi = $('#deskripsi').val();
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'uploadB.php',
                        data: {name: name,kategori_id: kategori_id,jumlah: jumlah,satuan: satuan,harga:harga,kondisi:kondisi,cara: cara,deskripsi: deskripsi },
...
<div class="col-md-7">
            ...
            Harga Barang :
            <input type="text" name="harga" required class="required form-control" id="harga" /><br>
            Cara Perolehan :
            <input type="text" name="cara" required class="required form-control"  id="cara" /><br>
            Kondisi Barang :
            <input type="text" name="kondisi" required class="required form-control"  id="kondisi" /><br>
