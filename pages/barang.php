               ...
               var name = $('#name').val();
                   ...
                   var deskripsi = $('#deskripsi').val();
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'pages/read.php',
                        data: {name: name,id: id,kategori_id: kategori_id,jumlah: jumlah,satuan: satuan,harga: harga,cara: cara,kondisi: kondisi,deskripsi: deskripsi },
 ...
 <script>  
      $(document).ready(function(){  
        ...
        <?php 
            ...
            $q=mysqli_query($koneksi,"select * from tb_barang limit ".$limit_start.",".$limit);
         ?>
                     <h3>Daftar Barang </h3>
        ...
        <?php if($_GET["del"]){
            mysqli_query($koneksi,"delete from tb_kategori where kategori_id = '$_GET[del]'");
...
<?php if(isset($_GET["view"])){ 
    $data = mysqli_fetch_array(mysqli_query($koneksi,"Select * from tb_barang where barang_id = '$_GET[view]'"));
    $kat = mysqli_fetch_array(mysqli_query($koneksi,"select * from tb_kategori where kategori_id = '$data[kategori_id]'"));
    ?>

<div style="border: 1px solid rgb(204, 204, 204); padding: 5px; overflow: auto; width: 100px; height: 80px;background-color: rgb(255, 255, 255);">
<div id="popup">
        <div class="window">
            ...
            <div class="panel-body">
                ...
                <div style="border: 1px solid rgb(204, 204, 204); padding: 5px; overflow: auto; width: 100%; height: 400px;background-color: rgb(255, 255, 255);">                                          
                    <div class="row">
                                            ...
                                            <div class="table-responsive panel">
                                                <table class="table">
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-success"><i class="fa fa-list-ol"></i> harga</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-success"><i class="fa fa-group"></i> Kondisi</td>
...
<div id="pedit">
        <div class="window">
            ...
            <select required class="form-control" id="kategori_id" name="kategori_id" <?php echo $read; ?> >
                <?php $q1 = mysqli_query($koneksi,"Select * from tb_kategori");
            ...
            harga Barang :
            <input type="text" name="harga" required class="required form-control" value="<?php echo $data['harga']; ?>" id="harga" /><br>
            Cara Perolehan :
            <input type="text" name="cara" required class="required form-control" value="<?php echo $data['cara_perolehan']; ?>" id="cara" /><br>
            <!-- Kondisi Barang :
            <input type="text" name="kondisi" required class="required form-control" value="<?php echo $data['kondisi']; ?>" id="kondisi" /><br> -->
