<div class="col-md-7">
   ...
   <script type="text/javascript" src="libs/jquery.min.js"></script>
    ...
    <?php 
      ...
      $q=mysqli_query($koneksi,"select * from tb_transaksi as t inner join tb_pinjam as p on t.pinjam_id = p.pinjam_id inner join tb_barang as b on p.barang_id = b.barang_id
                        ...
                        <tr class="add_persetujuan<?php echo $id ?>">
                          ...
                          <td><?php echo $data["nama_barang"]; ?></td>
                           ...
                           <?php  if($data['persetujuan']=="ya"){ ?>
                             <td class="alert-success">Barang bisa di ambil di gudang</td>
