<?php 
	...
	if(!isset($_SESSION["id"])){
			echo "<script>window.alert('Silahkan Login Terlebih Dahulu')</script>";
						echo "<script>window.location=('https://tjireng.my.id/inventaris/login')</script>";
	}
...
<base href="https://tjireng.my.id/inventaris/index.php">
  <head>
	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><marquee scrolldelay="10" title="Inventaris Denbekang V-44-02 Kota Mojokerto" behavior="play"><a href="https://tjireng.my.id/inventaris/" target="_blank">Inventaris Denbekang V-44-02 Kota Mojokerto</a></marquee></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
		  	...
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <?php if($a[level]=="admin"){  ?>
											<li class="current"><a href="signup.php"><i class="glyphicon glyphicon-user"></i> Tambah User</a></li>
                    <li class="submenu">
                         <a href="#">
                         ...
                         <ul>
							...
							<li><a href="./index/export/">Cetak Laporan</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                    <li class="submenu">
