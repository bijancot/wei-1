...
<div class="col-md-7">
 ...
 <script>  
    ...
    <?php 
      ...
      $q=mysqli_query($koneksi,"select * from tb_transaksi as t inner join tb_user as u on t.user_id = u.user_id inner join tb_pinjam as p on t.pinjam_id = p.pinjam_id inner join tb_barang as b on p.barang_id = b.barang_id
