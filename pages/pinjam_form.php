 ...
 <script type="text/javascript" src="libs/jquery.min.js"></script>
    ...
    messages: {
     ...
     jumlah: {required:"Tidak Boleh Kosong",digits:"Hanya dapat di isi angka"},
      ...
      tanggalbalik : "Tidak Boleh Kosong"
    },
        submitHandler: function (form) {
                   ...
                   var tanggalbalik = $('#tanggalbalik').val();
                   
                    $.ajax({
                        type: "POST",
                        url: 'pages/pinjam_proses.php',
                        data: {id: id,jumlah: jumlah,alasan: alasan,tanggalambil : tanggalambil, tanggalbalik : tanggalbalik },
...
<div class="col-md-7">
  <?php $data = mysqli_fetch_array(mysqli_query($koneksi,"select * from tb_barang where barang_id = '$_GET[id]'")) ?>
          ...
          <img src='images/barang/<?php echo $data["gambar"]; ?>' class='preview'><br><br>
            ...
            Tanggal Pengambilan :
            <input type="date" name="tanggalambil" required placeholder="2020-01-10" class="required form-control" id="tanggalambil" /><br>
            Tanggal Pengembalian :
            <input type="date" name="tanggalbalik" required placeholder="2020-01-10" class="required form-control" id="tanggalbalik" /><br>
                <div class="action">
