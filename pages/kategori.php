...
if (isset($_POST['Input'])) {
  ...
  $query = sprintf("INSERT INTO tb_kategori VALUES('%s', '%s', '%s')", 
      mysqli_escape_string($kategori_id), 
      mysqli_escape_string($nama_kategori), 
      mysqli_escape_string($keterangan)
    );
...
echo json_encode($pesan);
  ...
  $sql_total = mysqli_query($koneksi,$query_total) or die($query_total);
