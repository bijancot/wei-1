	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-12">
	              <!-- Logo -->
	              <div class="logo">
				  <h1><marquee scrolldelay="10" title="Inventaris Denbekang V-44-02 Kota Mojokerto" behavior="play"><a href="http://127.0.0.1/inventaris/" target="_blank">Selamat Datang Di Inventaris Denbekang V-44-02 Kota Mojokerto</a></marquee></h1>
	              </div>
	           </div>
	        </div>
	     </div>
				...
				<div class="login-wrapper">
			        <div class="box">
			            <div class="content-wrap">
			                <h3>INVENTARIS DENBEKANG V-44-02 KOTA MOJOKERTO</h3>
			                <div class="social">
	                            <div class="division">
	                                <?php if($_GET["pesan"]){ ?>
